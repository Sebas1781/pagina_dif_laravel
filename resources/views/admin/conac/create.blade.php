...
@section('title', 'Nuevo Documento CONAC')
@section('page-title', 'Nuevo Documento CONAC')
...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <form method="POST" action="{{ route('admin.conac.store') }}" enctype="multipart/form-data" novalidate>
            @csrf
            ...
            <div class="mb-5">
                ...
                <input type="text" id="categoria" name="categoria" value="{{ old('categoria') }}" list="lista-categorias"
                       ...
                       placeholder="Ej. Normas Generales, Criterios Contables...">
            ...
            <div class="mb-5">
                ...
                <input type="text" id="nombre" name="nombre" value="{{ old('nombre') }}"
                       ...
                       placeholder="Ej. Postulados Básicos de Contabilidad Gubernamental">
                @error('nombre')
                    <p class="mt-1.5 text-xs text-red-600">{{ $message }}</p>
                @enderror
            </div>
