...
@section('title', 'Nuevo PDF de Inicio')
@section('page-title', 'Nuevo PDF de Inicio')
...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <form method="POST" action="{{ route('admin.documentos_inicio.store') }}" enctype="multipart/form-data" novalidate>
            @csrf
            ...
            <div class="mb-5">
                ...
                <div id="fuente-archivo" class="{{ old('tipo_fuente', 'archivo') === 'archivo' ? '' : 'hidden' }}">
                    ...
                    <p class="mt-1 text-xs text-gray-400">Solo archivos PDF. Máx. 200 MB.</p>
                    @error('archivo')
                        <p class="mt-1.5 text-xs text-red-600">{{ $message }}</p>
                    @enderror
                </div>
