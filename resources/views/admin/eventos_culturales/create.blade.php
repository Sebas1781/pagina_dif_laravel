...
@section('title', 'Nuevo Evento Cultural')
@section('page-title', 'Nuevo Evento Cultural')
...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <form method="POST" action="{{ route('admin.eventos_culturales.store') }}" enctype="multipart/form-data" novalidate>
            @csrf
