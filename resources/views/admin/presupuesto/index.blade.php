...
@section('title', 'Documentos Presupuesto')
@section('page-title', 'Documentos Presupuesto')
...
@section('content')
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <p class="text-sm text-gray-500 mt-0.5">Gestiona los documentos de Presupuesto y ejercicio del gasto.</p>
        </div>
        <a href="{{ route('admin.presupuesto.create') }}"
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 mb-5">
        <form method="GET" action="{{ route('admin.presupuesto.index') }}" class="flex flex-wrap items-end gap-4">
            <div>
            ...
            <div>
                ...
                <input type="text" name="categoria" value="{{ request('categoria') }}" placeholder="Ej. Trimestral, Anual..."
            ...
            <div>
                ...
                <input type="text" name="buscar" value="{{ request('buscar') }}" placeholder="Ej. Presupuesto de Egresos..."
                       class="px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-dif-pink focus:border-transparent w-56">
            </div>
            <div class="flex gap-2">
                ...
                @if(request()->hasAny(['anio', 'categoria', 'buscar']))
                    <a href="{{ route('admin.presupuesto.index') }}" class="px-4 py-2 text-sm font-medium text-gray-600 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                        Limpiar
                    </a>
                @endif
            </div>
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                @endif
                                <a href="{{ route('admin.presupuesto.edit', $doc) }}"
                                ...
                                <form method="POST" action="{{ route('admin.presupuesto.destroy', $doc) }}"
                                      onsubmit="return confirm('¿Eliminar este documento de Presupuesto?')">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
                ...
                @empty
                    <tr>
                        <td colspan="7" class="px-5 py-16 text-center text-gray-400">
                            ...
                            No hay documentos de Presupuesto registrados aún.
                        </td>
                    </tr>
                @endforelse
            </tbody>
