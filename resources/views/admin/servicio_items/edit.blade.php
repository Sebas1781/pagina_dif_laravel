...
@section('title', 'Editar Elemento de Servicios')
@section('page-title', 'Editar Elemento de Servicios')
...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <form method="POST" action="{{ route('admin.servicio_items.update', $item) }}" novalidate>
            @csrf @method('PUT')
            @include('admin.servicio_items._form')
