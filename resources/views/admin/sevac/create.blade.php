...
@section('title', 'Nuevo Documento SEVAC')
@section('page-title', 'Nuevo Documento SEVAC')
...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <form method="POST" action="{{ route('admin.sevac.store') }}" enctype="multipart/form-data" novalidate>
            @csrf
            ...
            <div class="mb-5">
                ...
                <input type="text" id="categoria" name="categoria" value="{{ old('categoria') }}" list="lista-categorias"
                       ...
                       placeholder="Ej. CONAC TÍTULO IV — 1er Trimestre 2024">
